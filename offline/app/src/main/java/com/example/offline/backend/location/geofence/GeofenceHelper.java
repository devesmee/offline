...
import com.example.offline.backend.location.service.GeofenceBoardcastReceiver;
...
public class GeofenceHelper extends ContextWrapper {
    ...
    public Geofence getGeofence(String ID, LatLng latLng, float radius, int types) {
